...
var onMessage = function(request, sender, callback) {
    ...
    switch ( request.what ) {
    case 'getBlacklist':
        response = µb.stringFromBlacklist(µb.netBlacklist);
        break;

    case 'setBlacklist':
        µb.netBlacklist = µb.blacklistFromString(request.blacklist);
        µb.saveBlacklist();
        break;
...
vAPI.messaging.listen('blacklist.js', onMessage);
...
var backupUserData = function(callback) {
    var userData = {
        ...
        filterLists: {},
        netBlacklist: µb.stringFromBlacklist(µb.netBlacklist),
...
var restoreUserData = function(request) {
    ...
    var onAllRemoved = function() {
        ...
        µb.keyvalSetOne('netBlacklist', userData.netBlacklist || '', onCountdown);
...
var onMessage = function(request, sender, callback) {
    ...
    switch ( request.what ) {
    case 'temporarilyBlacklistDocument':
        µBlock.webRequest.temporarilyBlacklistDocument(request.hostname);
        break;
