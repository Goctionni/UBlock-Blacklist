...
µBlock.saveBlacklist = function() {
    this.keyvalSetOne('netBlacklist', this.stringFromBlacklist(this.netBlacklist));
    this.netBlacklistModifyTime = Date.now();
};
...
µBlock.restoreAdminSettings = function() {
    ...
    if ( typeof data.netBlacklist === 'string' ) {
        bin.netBlacklist = data.netBlacklist;
        binNotEmpty = true;
    }
